...
#define EDIT_START_AD {658,283,80,EDIT_H,"0"}
#define EDIT_END_AD   {658,353,80,EDIT_H,"0"}
...
#define BUTTON_CAB_ANGLE_START     {1,360,50}
#define BUTTON_CAB_ANGLE_STOP      {2,490,50}
#define BUTTON_CAB_UPAGL_START     {3,360,120}
#define BUTTON_CAB_UPAGL_STOT      {4,490,120}
#define BUTTON_CAB_CAR_START       {5,360,190}
#define BUTTON_CAB_CAR_STOP        {6,490,190}
#define BUTTON_CAB_WET_START       {7,360,260}
#define BUTTON_CAB_WET_STOP        {8,490,260}
#define BUTTON_CAB_HIG_START       {9,360,330}
#define BUTTON_CAB_HIG_STOP        {10,490,330}
#define SKIN_BUTTON_EXIT           {11,738,     8}
#define BUTTON_LIJU                 {12,360,400}
