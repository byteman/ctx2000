...
/*
 * $Id: keyboard.c 175 2008-01-09 08:34:10Z tangjianbin $
...
load_quanpin_input_method(void)
{
    ...
    table->item = (_ITEM *) (table + 1);
    //printf ("item 1 (%x), item 2 (%x).\n", table->item[0].key1, table->item[0].key2);
